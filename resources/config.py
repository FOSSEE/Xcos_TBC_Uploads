...
XCOSSOURCEDIR = '/Sites/xcos_on_cloud/uploads'
...
SCILAB_MIN_INSTANCES = 25
SCILAB_START_INSTANCES = 40
SCILAB_MAX_INSTANCES = 150
SCILAB_INSTANCE_RETRY_INTERVAL = 3

# the delay

TKSCALE_START_DELAY = 1.5
SCILAB_INSTANCE_TIMEOUT_INTERVAL = 150
